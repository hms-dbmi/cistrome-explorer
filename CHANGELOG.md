...
- Added `TrackColTools` component, which will show tools for manipulating genome interval selections, and will be positioned above or below `horizontal-multivec` tracks.
