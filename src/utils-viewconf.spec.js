...
describe('Utilities for processing higlass view config objects', () => {
    it('Should find all horizontal-multivec track IDs', () => {
        const trackIds1 = getHorizontalMultivecTracksFromViewConfig(hgDemoViewConfig1);
        ...
        const trackIds2 = getHorizontalMultivecTracksFromViewConfig(hgDemoViewConfig2);
