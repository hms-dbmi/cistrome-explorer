...
import TrackRowInfoVisNominalBar from "./TrackRowInfoVisNominalBar.jsx";
import TrackRowInfoVisQuantitativeBar from "./TrackRowInfoVisQuantitativeBar.jsx";
import TrackRowInfoVisLink from "./TrackRowInfoVisLink.jsx";
import TrackRowInfoVisDendrogram from "./TrackRowInfoVisDendrogram.jsx";
...
export default function TrackRowInfoVis(props) {
    ...
    const { type, field, url, alt, shortName, color, colors, only, categories, aggFunction, resolveYScale, domain, range, addTrackOnClick } = fieldInfo;
