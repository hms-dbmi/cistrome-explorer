...
import { getExampleCistromeTracks } from '../cistrome-api/cistrome-track';

export const theme = gt.getTheme();

export const hgDemoViewConfig3k27Revision = {
	editable: false,
	zoomFixed: false,
	...
	views: [
		{
			...
			tracks: {
				top: [
					...
					},
					{
						...
						uid: 'chromosome-labels-track-3k27-revision',
						chromInfoPath: '//aveit.s3.amazonaws.com/higlass/data/sequence/hg38.mod.chrom.sizes',
						options: {
					...
					...getExampleCistromeTracks(),
					{
						...
						uid: 'gene-labels-track-3k27-revision',
						options: {
				...
				center: [
					{
						...
						uid: 'cistrome-track-3k27-revision',
						tilesetUid: 'h3k27ac_revision',
			...
			uid: 'cistrome-view-3k27-revision'
		}
	],
	zoomLocks: {
		locksByViewUid: {},
