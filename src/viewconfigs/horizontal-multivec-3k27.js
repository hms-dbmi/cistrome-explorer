...
export const hgDemoViewConfig3k27 = {
	editable: false,
	zoomFixed: false,
			...
			tracks: {
				top: [
					...
					},
					{
						...
						uid: 'chromosome-labels-track-3k27',
						chromInfoPath: '//aveit.s3.amazonaws.com/higlass/data/sequence/hg38.mod.chrom.sizes',
						options: {
				...
				center: [
					{
						...
						uid: 'cistrome-track-3k27',
						tilesetUid: 'cistrome-h3k27ac-multivec',
