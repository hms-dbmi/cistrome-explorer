...
const HiGlassMetaConsumer = forwardRef((props, ref) => {
    ...
    useEffect(() => {
        ...
        const newViewConfig = setDataTransformOfTopTrackFromViewConfig(
            currViewConfig, 
            ["cistrome-view-1", "cistrome-view-atac", "cistrome-view-atac-revision", "cistrome-view-3k27", "cistrome-view-3k27-revision", 'cistrome-track-3k4', 'cistrome-track-3k4-revision'], 
            "gwas", 
    ...
    return (
        <div className="hm-root">
            ...
            {stackedBarTrackIds.map(({ viewId, trackId }, i) => {
                ...
                return (
                    <div key={i} style={{ left: left + w - 20, top: top + 3, position: "absolute", height: h }}
