...
export default function GwasFilter(props) {
	const { top, left, oneOf, keyword, onKeywordChange: setKeyword, onFilter, onClose } = props;
	...
	return (
		...
		>
			...
			>
				...
				/>
				<svg className="hm-button-sm" onClick={onResetClick} viewBox={SQUARE_CHECK.viewBox}>
