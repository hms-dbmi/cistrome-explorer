...
import ViewColumnBrush from './ViewColumnBrush.jsx';
...
import { destroyTooltip, publishHelpTooltip } from './Tooltip.jsx';
...
export default function ViewWrapper(props) {
	...
	return assembly ? (
		<div className="hm-view-wrapper">
			...
			>
				<div
					className={'col-tools-brush-bar ' + (helpActivated ? 'help-highlight' : '')}
					ref={divRef}
					onMouseMove={e =>
						publishHelpTooltip(
							e,
				...
				>
					{mouseHoverX && !brushStartX ? (
						// Short vertical line.
						<div className="col-tools-hover-line" style={{ left: `${mouseHoverX}px` }} />
					) : null}
				...
				<div className="col-tools-hg-overlay">
					{brushStartX !== null && brushEndX !== null ? (
						...
						<div
							className="col-tools-brush-black"
							style={{
								left: brushStartX,
								width: brushEndX - brushStartX
							}}
