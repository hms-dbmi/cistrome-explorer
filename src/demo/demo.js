    ...
    e18_mouse_brain_10x_top_500_smooth: {
        ...
        options: [{
            ...
            rowInfoAttributes: [
                ...
                { field: "index", url: "https://s3.amazonaws.com/gosling-lang.org/data/cistrome/e18_mouse_brain_10x_rna_main.zarr/", type: "expression", position: "right", width: 80, title: "XKR4" },
            ],
            rowAggregate: [],
            rowSort: [
